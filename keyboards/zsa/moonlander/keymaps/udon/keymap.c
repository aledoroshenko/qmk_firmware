...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_DELETE,      KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           OSL(4),                                         TG(2),          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,
    ...
    LT(2,KC_GRAVE), CW_TOGG,        KC_TRANSPARENT, TO(0),          TD(DANCE_1),    MT(MOD_LALT, KC_APPLICATION),                                                                                                MT(MOD_LCTL, KC_ESCAPE),LCTL(KC_LBRC),  TO(1),          KC_LBRC,        KC_RBRC,        MO(2),
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RU_YO,          KC_TRANSPARENT, KC_TRANSPARENT,
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[2].step) {
        case SINGLE_TAP: register_code16(LALT(LGUI(KC_BSLS))); break;
        case DOUBLE_TAP: register_code16(LALT(LCTL(LGUI(LSFT(KC_BSLS))))); break;
        case DOUBLE_SINGLE_TAP: tap_code16(LALT(LGUI(KC_BSLS))); register_code16(LALT(LGUI(KC_BSLS)));
    }
}
...
void dance_2_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[2].step) {
        case SINGLE_TAP: unregister_code16(LALT(LGUI(KC_BSLS))); break;
        case DOUBLE_TAP: unregister_code16(LALT(LCTL(LGUI(LSFT(KC_BSLS))))); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(LALT(LGUI(KC_BSLS))); break;
    }
